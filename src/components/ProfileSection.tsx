          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {subjects.map(subject => <div key={subject.id} className="flex items-center space-x-2">
                  <Checkbox id={subject.id} checked={userSubjectIds.includes(subject.id)} onCheckedChange={checked => handleSubjectChange(subject.id, checked as boolean)} className="bg-[#039559] font-extralight" />
