...
const Header = () => {
  ...
  const {
    data: logoUrlData
  } = supabase.storage.from('logos').getPublicUrl('WISE Logo.png');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-4">
            {!logoError ? <img src={logoUrl} alt="WISE Logo" className="h-12 w-auto object-contain" onLoad={() => console.log("Logo loaded successfully")} onError={e => {
          ...
          <div className="flex items-center space-x-4">
            ...
            {showMenu && <Menubar>
                <MenubarMenu>
                  ...
                  <MenubarContent>
                    {roles.includes("teacher") && <MenubarItem onClick={handleTeacherDashboard}>
                        Teacher Dashboard
                      </MenubarItem>}
                    {roles.includes("admin") && <MenubarItem onClick={handleAdminDashboard}>
                        Admin Dashboard
                      </MenubarItem>}
                  </MenubarContent>
                </MenubarMenu>
